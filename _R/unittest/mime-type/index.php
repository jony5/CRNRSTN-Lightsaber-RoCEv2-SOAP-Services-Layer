...
$oCRNRSTN->config_integrate_file_system('BLUEHOST_EVIFWEB','https://evifweb.com/common/', '/var/evifwebc1/public_html/evifweb.com/common/', CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_RUNTIME & CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_SESSION, 120);
$oCRNRSTN->config_integrate_file_system('LOCALHOST_PC', 'http://172.16.225.138/evifweb.com/common/', '/var/www/html/evifweb.com/common/', CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_RUNTIME & CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_SESSION, 120);      // WINDOWS XP VM WARE - MACBOOK PRO CHAD [eVifweb].
$oCRNRSTN->config_integrate_file_system('LOCALHOST_CHAD_MACBOOKPRO', 'http://172.16.225.139/evifweb.com/common/', '/var/www/html/evifweb.com/common/', CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_RUNTIME & CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_SESSION, 120);
...
//
// PLZ SEE _R/class/ui/crnrstn.ui_html_manager.inc.php, [LINE 94].
...
//$oCRNRSTN->system_output_head_html(CRNRSTN_CLIENT_SSDTLA, true, true);
...
<head>
    ...
    //echo $oCRNRSTN->system_output_file_html('../favicon.ico', CRNRSTN_ICO);
