...
$tmp_file_path = $_SERVER['DOCUMENT_ROOT'] . 
                 $tmp_application_folder .  $tmp_slsh . 
                 '_R' . $tmp_slsh . 
                 '_config' . $tmp_slsh . 
                 'config.system_paths' . $tmp_slsh;
...
//error_log('28 curl index die() crc32(\'Subliminal\')=' . $oCRNRSTN->crc_int32('Subliminal'));  // 5 :: Tuesday, July 5, 2022 @ 1537 hrs.
...
<div id="crnrstn_curl_data_storage" style="font-family:Arial, Helvetica, sans-serif; padding:0 10px 10px 20px; width:810px;">
    ...
    <div style="font-weight: bold; font-size: 25px; padding: 10px 0 0 0; color: #FFF;">C<span class="the_R">R</span>NRSTN :: Interact UI Button Events UX Laboratory</div>
