...
//error_log('28 curl index die() crc32(\'Subliminal\')=' . $oCRNRSTN_USR->crc_int32('Subliminal'));  // 5 :: Tuesday, July 5, 2022 @ 1537 hrs.
...
<?php echo $oCRNRSTN_USR->return_creative('CRNRSTN_ICO'); ?>
...
<div id="crnrstn_curl_data_storage" style="padding:0 10px 10px 20px; width:810px;">
    ...
    <div style="font-weight: bold; font-size: 25px; padding: 10px 0 0 0; color: #FFF;">C<span class="the_R">R</span>NRSTN :: UI Interact Button Events UX Laboratory</div>
    ...
    <div style="font-size: 11px; font-weight: normal; padding: 5px 0 0 0; color: #c2bfbf;">
        ...
        echo $oCRNRSTN_USR->proper_version('LINUX') .
            ...
            ', C<span class="the_R">R</span>NRSTN :: v' . $oCRNRSTN_USR->version_crnrstn(); ?>
    </div>
    ...
    <div style="text-align:left; background-color: #04050A; border: 3px solid #9F9393; width: 780px; height: 379px; overflow: scroll; padding: 15px 20px 15px 20px;">
        ...
        echo '<div class="crnrstn_cb_10"></div>';
        echo '<div class="crnrstn_log_entry">SOCIAL_ID_CRC 0 [' . $oCRNRSTN_USR->crc_int32($tmp_SOCIAL_ID) . ']';
        echo '</div>';
        ...
        echo '<div class="crnrstn_cb_10"></div>';
        echo '<div class="crnrstn_log_entry">SOCIAL_ID_CRC 1 [' . $oCRNRSTN_USR->crc_int32($tmp_SOCIAL_ID) . ']';
        echo '</div>';

        echo '<div class="crnrstn_cb_10"></div>';
        echo '<div class="crnrstn_log_entry">SOCIAL_MEDIA_KEY :: [profile][1300][' . $oCRNRSTN_USR->crc_int32('profile') . ']';
        echo '</div>';

        echo '<div class="crnrstn_cb_10"></div>';
        echo '<div class="crnrstn_log_entry">SOCIAL_MEDIA_KEY :: [archives][1400][' . $oCRNRSTN_USR->crc_int32('archives') . ']';
        echo '</div>';
    ...
    <form action="#" method="post" name="curl" id="curl"  enctype="multipart/form-data">
        ...
        <?php
        echo $oCRNRSTN_USR->ui_content_module_out(CRNRSTN_PSSDTLA_PACKET, 'curl');
        ?>
    </form>
...
echo $oCRNRSTN_USR->ui_content_module_out(CRNRSTN_SOAP_TUNNEL);
        ...
        <div style="position:relative; height:106px;">
            ...
            <div id="crnrstn_interact_ui_primary_navgroup_wrapper" class="crnrstn_interact_ui_primary_navgroup_wrapper">
                ...
                <div id="crnrstn_interact_ui_primary_nav_menu" class="crnrstn_interact_ui_primary_navgroup_lnk_border">
                    ...
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_menu_inactive" class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_menu_inactive.png" width="40" height="40" alt="Menu" title="Navigation to Menu"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_menu_hvr"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_menu_hvr.png" width="40" height="40" alt="Menu" title="Navigation to Menu"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_menu_click"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_menu_click.png" width="40" height="40" alt="Menu" title="Navigation to Menu"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_menu"  class="crnrstn_interact_ui_primary_nav_img_shell crnrstn_interact_ui_active"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_menu.png" width="40" height="40" alt="Menu" title="Navigation to Menu"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_menu_glass_case"  class="crnrstn_interact_ui_primary_nav_glass_case" onmouseover="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseover', this);" onmouseout="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseout', this);" onmousedown="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmousedown', this);" onmouseup="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseup', this);"><img src="../../../_R/ui/imgs/gif/x.gif" width="40" height="40" alt="Menu" title="Navigation to Menu"></div>

                </div>

                <div id="crnrstn_interact_ui_primary_nav_close_x" class="crnrstn_interact_ui_primary_navgroup_lnk_border">

                    <div id="crnrstn_interact_ui_primary_nav_img_shell_close_x_inactive"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_close_x_inactive.png" width="40" height="40" alt="Close" title="Navigation to Close"></div class="crnrstn_interact_ui_primary_nav_img_shell">
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_close_x_hvr"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_close_x_hvr.png" width="40" height="40" alt="Close" title="Navigation to Close"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_close_x_click"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_close_x_click.png" width="40" height="40" alt="Close" title="Navigation to Close"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_close_x"  class="crnrstn_interact_ui_primary_nav_img_shell crnrstn_interact_ui_active"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_close_x.png" width="40" height="40" alt="Close" title="Navigation to Close"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_close_x_glass_case"  class="crnrstn_interact_ui_primary_nav_glass_case" onmouseover="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseover', this);" onmouseout="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseout', this);" onmousedown="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmousedown', this);" onmouseup="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseup', this);"><img src="../../../_R/ui/imgs/gif/x.gif" width="40" height="40" alt="Close" title="Navigation to Close"></div>

                </div>

                <div id="crnrstn_interact_ui_primary_nav_fs_expand" class="crnrstn_interact_ui_primary_navgroup_lnk_border">

                    <div id="crnrstn_interact_ui_primary_nav_img_shell_fs_expand_inactive"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_fs_expand_inactive.png" width="40" height="40" alt="FullScreen" title="Navigation to Full Screen"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_fs_expand_hvr"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_fs_expand_hvr.png" width="40" height="40" alt="FullScreen" title="Navigation to Full Screen"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_fs_expand_click"  class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_fs_expand_click.png" width="40" height="40" alt="FullScreen" title="Navigation to Full Screen"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_fs_expand"  class="crnrstn_interact_ui_primary_nav_img_shell crnrstn_interact_ui_active"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_fs_expand.png" width="40" height="40" alt="FullScreen" title="Navigation to Full Screen"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_fs_expand_glass_case"  class="crnrstn_interact_ui_primary_nav_glass_case" onmouseover="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseover', this);" onmouseout="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseout', this);" onmousedown="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmousedown', this);" onmouseup="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseup', this);"><img src="../../../_R/ui/imgs/gif/x.gif" width="40" height="40" alt="FullScreen" title="Navigation to Full Screen"></div>

                </div>

                <div id="crnrstn_interact_ui_primary_nav_minimize" class="crnrstn_interact_ui_primary_navgroup_lnk_border">

                    <div id="crnrstn_interact_ui_primary_nav_img_shell_minimize_inactive" class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_minimize_inactive.png" width="40" height="40" alt="5" title="eVifweb development"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_minimize_hvr" class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_minimize_hvr.png" width="40" height="40" alt="5" title="eVifweb development"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_minimize_click" class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_minimize_click.png" width="40" height="40" alt="5" title="eVifweb development"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_minimize" class="crnrstn_interact_ui_primary_nav_img_shell"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_minimize.png" width="40" height="40" alt="5" title="eVifweb development"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_minimize_fivedev_sm" class="crnrstn_interact_ui_primary_nav_img_shell crnrstn_interact_ui_active"><img src="../../../_R/ui/imgs/png/primary_nav_seriesblue00_120x120_minimize_fivedev_sm.png" width="40" height="40" alt="5" title="eVifweb development"></div>
                    <div id="crnrstn_interact_ui_primary_nav_img_shell_minimize_glass_case" class="crnrstn_interact_ui_primary_nav_glass_case" onmouseover="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseover', this);" onmouseout="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseout', this);" onmousedown="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmousedown', this);" onmouseup="oCRNRSTN_JS.crnrstn_interact_ui_ux('onmouseup', this);"><img src="../../../_R/ui/imgs/gif/x.gif" width="40" height="40" alt="5" title="eVifweb development"></div>
