...
<div id="crnrstn_curl_data_storage" style="font-family:Arial, Helvetica, sans-serif; padding:0 10px 10px 20px; width:810px;">
    ...
    <div style="font-weight: bold; font-size: 25px; padding: 10px 0 0 0;">C<span class="the_R">R</span>NRSTN :: CURL v7.58.0</div>
    ...
    <div class="crnrstn_cb"></div>
    <div class="crnrstn_page_subtitle">C<span class="the_R">R</span>NRSTN :: CURL Results RAW Output</div>
