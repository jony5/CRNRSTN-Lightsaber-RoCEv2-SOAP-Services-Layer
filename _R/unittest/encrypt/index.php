...
$cipher_ARRAY                           =
$algorithm_ARRAY                        =
$cipher_dom_log_ARRAY                   =
$cipher_dom_combo_ARRAY                 =
$cipher_dom_chkbx_ARRAY                 =
$cipher_dom_chkbx_state_ARRAY           =
$algorithm_dom_log_ARRAY                =
$algorithm_dom_combo_ARRAY              =
$algorithm_dom_chkbx_ARRAY              =
...
<div id="crnrstn_openssl_data_storage" style="Cpadding:0 10px 10px 20px; width:810px;">
    ...
    <div style="font-size: 11px; font-weight: normal; padding: 5px 0 0 0; color: #9a9292;">
        ...
        echo $oCRNRSTN->proper_version('LINUX') .
            ...
            ', C<span class="the_R">R</span>NRSTN :: v' . $oCRNRSTN->version_crnrstn();  ?>
    </div>
    ...
    <form action="#" method="post" name="openssl_mysql_storage_performance" id="openssl_mysql_storage_performance"  enctype="multipart/form-data">
        ...
        echo $oCRNRSTN->ui_content_module_out(CRNRSTN_PSSDTLA_PACKET, 'openssl_mysql_storage_performance');
    ...
    Here is a list of available ciphers and aliases that can be used by C<span class="the_R">R</span>NRSTN :: to
    enable execution of data_decrypt()/data_encrypt(). See: <em>/_R/_config/config.encryption.secure/_crnrstn.encryption.inc.php</em>.<br>
    ...
    C<span class="the_R">R</span>NRSTN :: when using the HMAC library to generate a
    keyed hash value. See: <em>/_R/_config/config.encryption.secure/_crnrstn.encryption.inc.php</em>.<br>
