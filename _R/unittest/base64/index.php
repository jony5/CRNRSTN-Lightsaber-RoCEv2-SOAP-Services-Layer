...
// CRNRSTN_SOAP_TUNNEL, CRNRSTN_BASE64, CRNRSTN_BASE64_PNG,
...
//$tmp_custom_images_dir = $oCRNRSTN->get_resource('DOCUMENT_ROOT') . $oCRNRSTN->get_resource('DOCUMENT_ROOT_DIR') . '/_R/demo/common/imgs/j5_my_boy/_thumb/';
...
//$tmp_custom_images_dir = $oCRNRSTN->get_resource('DOCUMENT_ROOT') . $oCRNRSTN->get_resource('DOCUMENT_ROOT_DIR') . '/_R/demo/common/imgs/j5_my_boy/_thumb/2010_10_30_11.11.56_j5_octane_00.png';
//$oCRNRSTN->system_base64_integrate($tmp_custom_images_dir, 5);
        ...
        <div style="padding:0 20px 0 20px;">
            ...
            <div style="height: 170px; overflow: scroll;">
                ...
                <div id="base64_encoding" class="crnrstn_log_entry" style="overflow-wrap: break-word; padding: 4px 0 0 0; width: 100%;"><?php
                    ...
                    $tmp_base64_encoding .= $oCRNRSTN->data_encrypt('STATUS 200', CRNRSTN_ENCRYPT_TUNNEL & CRNRSTN_CHANNEL_DATABASE);
...
//                    }
    ...
    <form action="./?<?php echo $oCRNRSTN->data_decrypt($oCRNRSTN->get_resource('CRNRSTN_SYSTEM_DATA_GET')); ?>=#" method="post" enctype="multipart/form-data" id="crnrstn_image_to_encode" name="crnrstn_image_to_encode" data-ajax="false">
        ...
        echo $oCRNRSTN->ui_content_module_out(CRNRSTN_PSSDTLA_PACKET, 'crnrstn_image_to_encode');

        if($tmp_filename = $oCRNRSTN->return_form_submitted_value('crnrstn_image_to_process_name')){

            $tmp_str_array = array();
            $tmp_found_img_ping_type = false;
            $tmp_file_path = $oCRNRSTN->get_resource('DOCUMENT_ROOT') . $oCRNRSTN->get_resource('DOCUMENT_ROOT_DIR') . '/_R/ui/imgs/png/' . $tmp_filename;
            ...
            if(is_file($tmp_file_path)){
                ...
                if ($pos_png !== false) {
                    ...
                    $tmp_cache_version_png = $oCRNRSTN->file_url_cache_id(CRNRSTN_ROOT . '/_R/ui/imgs/png/' . $tmp_filename);
                ...
                if ($pos_jpg !== false || $pos_jpeg !== false) {
                    ...
                    $tmp_found_img_ping_type = true;
                    $tmp_cache_version_jpg = $oCRNRSTN->file_url_cache_id(CRNRSTN_ROOT . '/_R/ui/imgs/jpg/' . $tmp_filename);
                ...
                if ($pos_php !== false) {
                    ...
                    $tmp_found_img_ping_type = true;
                    $tmp_cache_version_php = $oCRNRSTN->file_url_cache_id(CRNRSTN_ROOT . '/_R/ui/imgs/base64/' . $tmp_filename);
