...
$tmp_file_path = $_SERVER['DOCUMENT_ROOT'] . 
                 $tmp_application_folder . 
                 $tmp_framework_dir . $tmp_slsh . 
                 'class' . $tmp_slsh . 
                 'session' . $tmp_slsh;
...
$tmp_str = '/*
    ...
    Example ::
    $oCRNRSTN->config_add_resource(\'BLUEHOST\', \'ROOT_PATH_CLIENT_HTTP\', \'http://jony5.com/\', CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_RUNTIME);
...
if(!$this->oCRNRSTN->isset_data_key($crnrstn_form_handle, $tmp_data_type_family)){
    ...
    // add_resource($data_key, $data_value, $data_type_family = \'CRNRSTN::RESOURCE\', $data_auth_profile = CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_RUNTIME){
...
$tmp_str = '$oCRNRSTN->get_resource($data_key, $index = NULL, $data_type_family = \'CRNRSTN::RESOURCE\', $data_auth_request = CRNRSTN_AUTHORIZE & CRNRSTN_CHANNEL_RUNTIME);';
...
$oCRNRSTN->system_base64_integrate(CRNRSTN_ROOT . '/_R/demo/common/imgs/j5_my_boy/_thumb/', 5);
...
<!---->
<!--    --><?php
//    //echo $oCRNRSTN->ui_content_module_out(CRNRSTN_PSSDTLA_PACKET, 'curl');
//    ?>
<!--</form>-->
