 ...
 *       5 :: Tuesday, June 16, 2026 @ 0137 hrs.
 *
 * # C # R # N # R # S # T # N # :: # L # I # G # H # T
 * Edit: Modified the PHPMailer namespace
 ...
 *       \crnrstn_SMTP.php:45
 *
 *       5 :: Thursday, August 20, 2026 @ 2155 hrs.
 *
 *
 */
...
class crnrstn_PHPMailer extends crnrstn 
{
     ...
     *       5 :: Friday, March 13, 2026 @ 1417 hrs.
     *
     */
    ...
    public function __construct($exceptions = null)
    {
        ...
        $this->SMTPDebug = $this->get_crnrstn('phpmailer_debug_mode');
...
//            $result .= static::$LE;
    ...
    {
        /* # C # R # N # R # S # T # N # :: # L # I # G # H # T
         * Edit: Modified the protected lang 
         *       method in crnrstn_PHPMailer by 
         *       adding the CLR-SSL framework 
         *       iso_lang_code input parameter to 
         *       the PHPMailer language  
         *       initialization setLanguage() 
         *       method call in order for the 
         *       CLR-SSL to be able to articulate 
         *       error state in over 50 languages 
         *       here in the summer of 2026. 
         *       5 :: Wednesday, June 17, 2026 @ 0808 hrs.
         *
         */

        if (count($this->language) < 1) {
            $this->setLanguage($this->get_crnrstn('iso_lang_code')); // set the default language
        }
