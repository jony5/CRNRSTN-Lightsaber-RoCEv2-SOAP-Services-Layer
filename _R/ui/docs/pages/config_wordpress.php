...
switch($channel_constant[0]){
    ...
    <head>
        ...
        ' . $this->oCRNRSTN_USR->return_creative('CRNRSTN_ICO') . '
                    ...
                    <div class="crnrstn_left_nav_col_wrapper">
                        <div class="crnrstn_left_nav_button_wrapper">
                            <ul>
                                ...
                                <li><div class="crnrstn_left_nav_li_btn_shell">C<span class="the_R">R</span>NRSTN :: Configuration</div></li>
                                <div class="crnrstn_cb_10"></div>
                                ...
                                <div class="crnrstn_cb_10"></div>
                                <li><div class="crnrstn_left_nav_li_btn_shell">C<span class="the_R">R</span>NRSTN :: Debug Trace</li>
                                <div class="crnrstn_cb_10"></div>
            ...
            <div class="crnrstn_right_section_abs_out_wrapper">
                <div id="crnrstn_right_section_abs_wrapper" class="crnrstn_right_section_abs_wrapper">
                    <div class="crnrstn_right_section_rel_wrapper">
                        <h1>C<span class="the_R">R</span>NRSTN :: WordPress Configuration</h1>
            ...
            <div id="crnrstn_footer_abs_wrapper" class="crnrstn_footer_abs_wrapper">
                <div class="crnrstn_footer_rel_wrapper">
                    ...
                    <div class="crnrstn_footer_content_wrapper">
                        ...
                        <div class="crnrstn_copyright_shell">&copy; 2012-'.date('Y').' Jonathan \'5\' Harris :: All Rights Reserved in accordance with<br>the latest version of the <a href="' . $tmp_mit_lnk.'" target="_self">MIT License</a>.</div>
