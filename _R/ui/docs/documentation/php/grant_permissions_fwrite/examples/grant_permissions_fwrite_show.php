...
$tmp_big_data_size = $this->return_bytes(
                            107374182400, 
                            2, 
                            NULL, 
                            false); // 100GB
...
if($this->grant_permissions_fwrite($tmp_write_path, $tmp_small_data_size)){
    ...
    echo 'Permission granted to write ' . $this->return_bytes($tmp_small_data_size, 4) . ' of data.<br><br>';

}else{

    echo 'Permission DENIED to write ' . $this->return_bytes($tmp_small_data_size, 4) . '!<br><br>';
...
if($this->grant_permissions_fwrite($tmp_write_path, $tmp_big_data_size)){
    ...
    echo 'Permission granted to write ' . $this->return_bytes($tmp_big_data_size, 4) . '!';

}else{

    echo 'Permission DENIED to write ' . $this->return_bytes($tmp_big_data_size, 4) . '!';
