...
//
// FAKE SOME BIG DATA.
$tmp_big_data = $this->generate_new_key(50);
...
if($this->grant_permissions_fwrite($tmp_write_path, $tmp_big_data_size)){
    ...
    $tmp_html_out .= 'Permission granted to write ' . $this->return_bytes($tmp_big_data_size, 4) . '!';

}else{

    $tmp_html_out .= 'Permission DENIED to write ' . $this->return_bytes($tmp_big_data_size, 4) . '!';
