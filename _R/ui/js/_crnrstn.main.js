...
IMPACTING UI/UX ::
    ...
    ~ ACCOUNT ACTIVITY
        ...
        * LIVING STREAMS COMMUNICATIONS MESSAGING 
          ...
          WRITES OF CRNRSTN :: DRIVEN MOBILE DEVICE 
          COMMUNICATIONS WHERE LOGGING INTO 
          CRNRSTN :: WILL EXPOSE TO THE SAME
...
(function (root, factory){
    ...
    function CRNRSTN_JS(options){
        ...
        this.session_salt = '';
        this.R_debug_mode = this.CRNRSTN_DEBUG_LIFESTYLE_BANNER;
...
//        if(this.crnrstn_ui_component_state_ARRAY[component_key].length){
    ...
    CRNRSTN_JS.prototype.crnrstn_init = function(){
        ...
        $(document).ready(function() {
            ...
            if(self.R_debug_mode === self.CRNRSTN_DEBUG_OFF){
                ...
                if(self.CRNRSTN_LOGGING_OUTPUT === 'DOM'){
                    ...
                    if($('#crnrstn_client_ssdtla_debug_active').length){
                        ...
                        $('<div id="crnrstn_activity_log_output_wrapper">' +
                            '<div id="crnrstn_activity_log_output_title" style="float:left; padding:5px 0 5px 10px; text-align:left; font-family: Courier New, Courier, monospace; font-size:20px;">C<span class="the_R">R</span>NRSTN :: SOAP-SERVICES DATA TUNNEL LAYER ARCHITECTURE (SSDTLA) :: DEBUG</div>' +
    ...
    CRNRSTN_JS.prototype.load_system_settings = function(){
        ...
        */
        ...
        if(tmp_attribute_value = this.load_setting_attribute('crnrstn_client_debug_mode')){
            ...
            this.R_debug_mode = parseInt(tmp_attribute_value);
   ...
   //     this.consume_data_tunnel_xml_node(response_data, 'response_server_runtime', 'server_runtime', '', serialize_response);
    ...
    //         ' . $this->oCRNRSTN_USR->ui_content_module_out(CRNRSTN_PSSDTLA_PACKET, 'crnrstn_soap_data_tunnel_form').'
    //
    //     </form>
    //
    //     </div>';
    ...
    CRNRSTN_JS.prototype.sync_theme_styles_page_title = function(){
        ...
        THEME DATA
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_font_family'][] = 'Arial, Helvetica, sans-serif';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_color'][] = '#333';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_line_height'][] = '55px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_padding_top'][] = '0';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_padding_right'][] = '10px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_padding_bottom'][] = '0';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_padding_left'][] = '20px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_text_shadow'][] = '1px 1px 2px #ECECEC, 0 0 1em #ECECEC, 0 0 0.2em #ECECEC';

        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_font_size_h1'][] = '45px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_font_size_h2'][] = '35px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_font_size_h3'][] = '25px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_font_size_h4'][] = '15px';
        $R_theme_data[$int_const]['interact.ui.document_page_title_copy_margin_bottom'][] = '0';
    ...
    CRNRSTN_JS.prototype.sync_theme_styles_page_description = function(){
        ...
        $R_theme_data[$int_const]['interact.ui.'][] = '0';
        $R_theme_data[$int_const]['interact.ui.'][] = '0';
        $R_theme_data[$int_const]['interact.ui.'][] = 'left';

        $R_theme_data[$int_const]['interact.ui.'][] = 'none';
        $R_theme_data[$int_const]['interact.ui.'][] = '#0066CC';

        $R_theme_data[$int_const]['interact.ui.'][] = '0';
        $R_theme_data[$int_const]['interact.ui.'][] = '6px';
        $R_theme_data[$int_const]['interact.ui.'][] = '0';
        $R_theme_data[$int_const]['interact.ui.'][] = '0';
        $R_theme_data[$int_const]['interact.ui.'][] = '90px';
        */
    ...
    CRNRSTN_JS.prototype.sync_theme_styles_page_alert_caution = function(){
        ...
        $R_theme_data[$int_const]['interact.ui.document_page_alert_caution_border_wrap_border'][] = '85%';
        $R_theme_data[$int_const]['interact.ui.document_page_alert_caution_copy_text_align'][] = 'left';
        $R_theme_data[$int_const]['interact.ui.document_page_alert_caution_copy_paragraph_padding'][] = '0';
        $R_theme_data[$int_const]['interact.ui.document_page_alert_caution_copy_paragraph_background_color'][] = 'rgba(255, 255, 255, 0.67)';
    ...
    CRNRSTN_JS.prototype.return_log_date_string = function(date_obj, type, abbrev_type = 'short_str'){
        ...
        switch(type){
            ...
            case 'timestamp':
                ...
                output_str = day_wk + ' ' + month + ' ' + day_mth + ' ' + 
    ...
    */
    ...
    CRNRSTN_JS.prototype.load_image_lowest_z_indice = function(dom_element_alpha, dom_element_beta, image_uri){
        ...
        var image_html = '<img src="' + image_uri + '" width="1180" height="250" alt="Jonathan \'5\' Harris">';
    ...
    CRNRSTN_JS.prototype.jony5_lifestyle_banner_state_revert = function(delta){
        ...
        var image_html_alpha = '<img src="' + image_uri_alpha + '" width="1180" height="250" alt="Hi, I\'m Jonathan \'5\' Harris, a ravenous wolf of the tribe of Benjamin and one of the King\'s two swords, an eternal son of thunder, and messenger of the church in Philadelphia." title="Hi, I\'m Jonathan \'5\' Harris, a ravenous wolf of the tribe of Benjamin and one of the King\'s two swords, an eternal son of thunder, and messenger of the church in Philadelphia.">';
        var image_html_beta = '<img src="' + image_uri_beta + '" width="1180" height="250" alt="Hi, I\'m Jonathan \'5\' Harris, a ravenous wolf of the tribe of Benjamin and one of the King\'s two swords, an eternal son of thunder, and messenger of the church in Philadelphia." title="Hi, I\'m Jonathan \'5\' Harris, a ravenous wolf of the tribe of Benjamin and one of the King\'s two swords, an eternal son of thunder, and messenger of the church in Philadelphia.">';
